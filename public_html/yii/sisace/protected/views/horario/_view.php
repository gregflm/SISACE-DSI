...
<div class="view">
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('dia_desde')); ?>:</b>
	<?php echo CHtml::encode($data->dia_desde); ?>
	<br />

	<b><?php echo CHtml::encode($data->getAttributeLabel('dia_hasta')); ?>:</b>
	<?php echo CHtml::encode($data->dia_hasta); ?>
	<br />
<br><br>
</div>