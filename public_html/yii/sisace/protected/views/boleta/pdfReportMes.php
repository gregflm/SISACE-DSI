...
echo "<script languaje='javascript'>alert('Error , no hay datos'); location.href='http://www.google.cl';</script>";
} else {?>
...
<b>Total Resultados:</b> <?php echo $contador; ?>
				 ...
				 <td width="10%">Nº de Boleta</td>
				 <td width="30%">Total de Boleta</td>
				 </tr>
				 </thead>
				 <tbody>
				 <!-- ITEMS -->
				 ...
				 Total en pesos chilenos: $<?php echo $suma_total; ?></td>
				 </tr>
				 </tbody>
				 </table>
				 </body>
