...
class CrugeUi extends CComponent
{
    ...
    */
    ...
    {
        return array(
          //  array('label' => CrugeTranslator::t('admin', 'Administrar Usuarios')),
            array(
                'label' => CrugeTranslator::t('admin', 'Actualizar perfil')
            ,
           ...
           // ),
            array(
                'label' => CrugeTranslator::t('admin', 'Crear campo nuevo personzalido')
            ,
            ...
            array(
                'label' => CrugeTranslator::t('admin', 'Asignar roles a usuario')
            ,
    ...
    public function getAdminItemsAlternative()
    {
        return array(
            array('label' => CrugeTranslator::t('admin', 'User Manager'),'items'=>array(
				...
				array(
					'label' => CrugeTranslator::t('admin', 'Administrador de usuarios')
				,
					'url' => $this->getUserManagementAdminUrl()
				)
			)),
