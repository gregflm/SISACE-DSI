<div class="form">
<h1><?php echo ucwords(CrugeTranslator::t('admin', 'Administrador de Usuarios'));?></h1>
<?php 
/*
...
$cols[] = array(
	...
	'buttons' => array(
			'update'=>array(
				'label'=>CrugeTranslator::t('admin', 'Actualizar'),
				'url'=>'array("usermanagementupdate","id"=>$data->getPrimaryKey())'
			),
			'eliminar'=>array(
				'label'=>CrugeTranslator::t('admin', 'Eliminar'),
