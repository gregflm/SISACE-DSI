...
class Tarifa extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('descripcion','required','message' => 'Por favor, intruzca una descripción'),
			array('valor','required','message' => 'Por favor, introduzca una tarifa'),
			array('vigencia','required','message' => 'Por favor, introduzca la fecha desde cuando comenzará a regir la tarifa'),
